...
import { BundleAdminComponent } from './components/bundleadmin/bundleadmin.component';
...
const appRoutes: Routes = [
  ...
  {path:'bundleadmin', component: BundleAdminComponent},
...
@NgModule({
  ...
  declarations: [ AppComponent, BundlesComponent, BundleAdminComponent, SettingsComponent, SubscriptionsComponent, NotFoundComponent, VerificationsComponent, DetailedbundleComponent ],
